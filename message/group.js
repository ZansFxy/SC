...
zaki.sendMessage(anu.id, { image: await getBuffer(`https://hardianto.xyz/api/welcome3?profile=${shortpc.data}&name=${num.split("@")[0]}&bg=https://i.ibb.co/HnTFh7K/IMG-20220106-074445.jpg&namegb=anak%20muda&member=2022`), caption: teks, mentions : [num]})
...
zaki.sendMessage(anu.id, { image: await getBuffer(`https://hardianto.xyz/api/goodbye3?profile=${shortpc.data}&name=${num.split("@")[0]}&bg=https://i.ibb.co/HnTFh7K/IMG-20220106-074445.jpg&namegb=anak%20muda&member=2022`), caption: teks, mentions : [num]})
}
}  
}catch (e) {
console.log(e)
